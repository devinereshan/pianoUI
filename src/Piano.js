...
export default class Piano {
    constructor(targetElement, size, range) {
        this.pianoUI = new PianoUI(targetElement, size, range);
...
class PianoUI extends EventEmitter {
    ...
    buildUI() {
        ...
        for (let i = this.range[0]; i < this.range[1] + 1; i++) {
            ...
            if (i % 12 === 4 || i % 12 === 11) {
                console.log(`adding ghostkey. i: ${i}`);
        ...
        console.log(`white key width: ${whiteKeyWidth}`);
